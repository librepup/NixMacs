;;; filian-theme.el --- A vibrant variant of the Jungle kitty colorscheme.
...
(let ((bg "#0a0a05")
  ...
  (custom-theme-set-faces
   ...
   ;; Bright variants (using the same for consistency as per your Kitty config)
